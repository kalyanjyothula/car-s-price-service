...
export function Header(props: HeaderProps) {
  const { logo, headerLinks, title, logoLink } = props;
  return (
    <header>
      <nav className=" border-gray-200 px-4 lg:px-6 py-4 bg-gray-800">
        <div className="content flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          {logo && (
